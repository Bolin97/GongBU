...
#     dir: Optional[str] = Query(None), identifier: str = Depends(get_current_identifier)
# ):
#     dir = unquote(dir)
...
#         dir = dir.removeprefix("/")
#         base_dir = os.path.join(os.environ.get("FINETUNE_OUTPUT"), identifier)
#         full_path = os.path.abspath(os.path.join(base_dir, dir, new))
#         os.mkdir(full_path)
